...
<?php
                ...
                $sql = "SELECT * FROM cfn3 ORDER BY id DESC LIMIT 5";
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="img/eru2.jpg" alt="">
                    <h1 class="text-uppercase mb-4">Eru</h1>
                    <p>Eru is a vegetable from Cameroon. It is a specialty of the Bayangi people, 
                        of the Manyu region in southwestern Cameroon. It is vegetable soup made up of 
                        finely shredded leaves of the eru or okok. The eru is cooked with waterleaf or spinach, 
                        palm oil, crayfish, and either smoked fish, cow skin (kanda) or beef.</p>
                    <p><strong>Ingredients</strong></p>
                    <p>*6 cups of Eru leafs (okok)</p>
                    <p>*500 grams of Spinach (waterleaf)</p>
                    <p>*2 cups of crayfish</p>
                    <p>*2-3 pounds of meat/fish of choice(beef skin/canda, beef stripes, beef, goat meat, dried/smoked fish, stocked fish, snails)</p>
                    <p>*3-4 cups of palm oil</p>
                    <p>*1 crayfish seasoning cube (maggi crevette)</p>
                    <p>some salt to taste</p>
                    <p>*1 Habanero pepper (optional)</p>
                    <div>
                        <p><strong>Recipe</strong></p>
                        <p>Start by soaking the Eru leafs in water.
                        Wash your meat and chop int small pieces then put in the pot to boil.
                        While the meat boils, chop your spinach or waterleaf and set aside.</p>
                        <p>When your meat is half-boiled, season with salt. When it is cooked, add in spinach and start stirring. Spinach is quite soft and will shrink fast as seen below.
                        ...
                        Stir well and there it is, Eru is ready.
                        </p>
                        <p> Serve with Water Fufu or Garri. <strong>Enjoy your meal</strong></p>
                        <img src="img/eru.jpg" alt="">
                    </div>
                </div>
                <!-- Blog Detail End -->
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex overflow-hidden mb-3">
                        <img class="img-fluid" src="img/sp1.jpg" style="width: 100px; height: 100px; object-fit: cover;" alt="">
