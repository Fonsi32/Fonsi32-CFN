        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle title-yep" data-bs-toggle="dropdown"><span>Regions</span></a>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    <div class="border-start border-5 border-primary ps-5 mb-5">
                        ...
                        <h2 class="display-7  mb-3">Cameroonian cuisine is one of the most varied in Africa due to Cameroon's location on 
